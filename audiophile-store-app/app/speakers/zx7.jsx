...
import heroImg from '../assets/zx7(1).jpg'
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.productInfo}>
          ...
          <Text style={styles.productName}>ZX7 SPEAKER</Text>
          ...
          <Text style={styles.productPrice}>$ 3,500</Text>
        ...
        <View style={styles.gallery}>
          <Image
            source={require('@/app/assets/image-gallery-2(1).jpg')}
            style={styles.galleryImageSmall}
            resizeMode="cover"
          />
          <Image
            source={require('@/app/assets/image-gallery-2(2).jpg')}
            style={styles.galleryImageSmall}
            resizeMode="cover"
          />
          <Image
            source={require('@/app/assets/image-gallery-2(3).jpg')}
