    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.productInfo}>
          ...
          <Text style={styles.productName}>XX99 MARK II {'\n'}HEADPHONES</Text>
        ...
        <View style={styles.gallery}>
          <Image
            source={require('@/app/assets/image-gallery-1.jpg')}
            style={styles.galleryImageSmall}
            resizeMode="cover"
          />
          <Image
            source={require('@/app/assets/image-gallery-2.jpg')}
            style={styles.galleryImageSmall}
            resizeMode="cover"
          />
          <Image
            source={require('@/app/assets/image-gallery-3.jpg')}
