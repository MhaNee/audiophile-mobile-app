...
import heroImg from '../assets/xx99mark1.jpg'
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.productInfo}>
          ...
          <Text style={styles.productName}>XX99 MARK I {'\n'}HEADPHONES</Text>
          ...
          <Text style={styles.productPrice}>$ 1,750</Text>
          ...
          <View style={styles.actionRow}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                addToCart(
                  { id: 'xx99-mark-1', name: 'XX99 MARK I HEADPHONES', price: 1750 },
                  quantity
                )
              }
            >
        ...
        <View style={styles.gallery}>
          <Image
            source={require('@/app/assets/image-gallery-4(2).jpg')}
            style={styles.galleryImageSmall}
            resizeMode="cover"
          />
          <Image
            source={require('@/app/assets/image-gallery-4(3).jpg')}
            style={styles.galleryImageSmall}
            resizeMode="cover"
          />
          <Image
            source={require('@/app/assets/image-gallery-4(1).jpg')}
